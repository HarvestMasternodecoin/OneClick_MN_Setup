...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='harvest.conf'
CONFIGFOLDER='/root/.harvestcore'
COIN_DAEMON='harvestd'
COIN_CLI='harvest-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/HarvestMasternodecoin/HarvestCore/releases/download/v3.0.0.0/HarvestCore-3.0.0.0-daemon-ubuntu_16.04.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_BOOTSTRAP='https://github.com/HarvestMasternodecoin/HarvestCore/releases/download/v3.0.0.0/bootstrap.zip'
...
function download_node() {
  ...
  wget -q $COIN_TGZ
  tar xzvf HarvestCore-3.0.0.0-daemon-ubuntu_16.04.tar.gz
  cd rev >/dev/null 2>&1
...
addnode=107.170.198.173
addnode=192.81.214.238
addnode=159.203.35.209
addnode=159.203.97.37
addnode=159.89.151.78
addnode=46.101.78.34
...
function important_information() {
 ...
 echo -e "${GREEN}harvest-cli masternode status${NC}"
 echo -e "${GREEN}harvest-cli getinfo${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
